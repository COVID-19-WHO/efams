...
const [hums, updateHums] = useState([
                        ...
                        {id:"Education", img:hum2, title:"Research and Education", story:`
...
const [ Education, UpdateEducation ] = useState( {id:"s_f4", type:"research"} )
    ...
    return (
        <div style={{backgroundColor: '#EFF0F1',width: '100%',padding: "30px"}}>
        <BrowserRouter>
